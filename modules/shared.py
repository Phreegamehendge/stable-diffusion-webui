...
options_templates.update(options.options_section(('saving-images', "Saving images/grids"), {
    "samples_save": options.OptionInfo(True, "Always save all generated images"),
    "samples_format": options.OptionInfo('png', 'File format for images'),
    "samples_filename_pattern": options.OptionInfo("", "Images filename pattern", component_args=hide_dirs),
    "save_images_add_number": options.OptionInfo(True, "Add number to filename when saving", component_args=hide_dirs),
}))
